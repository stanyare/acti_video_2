...
(function($, window, document) {
    var Cross2 = {
        ...
        init: function(options, el) {
			...
			var title2 = $('.after').attr('title');

            this.$before = $('<div style="position: absolute;width:0;" class="cross2-item cross2-item-before resize"><h3>'+ title +'</h3></div>');
            this.$after = $('<div style="position: relative" class="cross2-item cross2-item-after"><h3>'+ title2 +'</h3></div>');
